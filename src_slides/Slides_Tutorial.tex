...
\begin{frame}[fragile]
  \frametitle{Decoded view of LUI and AUIPC}
...
\begin{frame}[fragile]
  \frametitle{Decoding LUI and AUIPC}
...
\begin{frame}[fragile]
  \frametitle{Executing LUI and AUIPC}
...
\begin{frame}[fragile]
  \frametitle{Executing LUI and AUIPC (contd.)}
...
\begin{frame}[fragile]
  \frametitle{Assembly language parsing and printing for LUI and AUIPC}
